...
```{r}
disc1 <- discrimination(eval_data(conf_data = penguins_conf, synth_data = penguins_postsynth))
...
disc2 <- discrimination(eval_data(conf_data = penguins_conf, synth_data = penguins_postsynth))
