...
#' 
#' Compute the population-weighted average of per-class truth probability,
#' aggregated by target variable
#' 
...
#' 
#' @return A tibble with columns `target_var` and `truth_probability`.
#' 
